 ...
 */
trigger Createcert on Certification__c (after update,after insert) {
    ...
    Id rectypeid = Schema.SObjectType.Certification__c.getRecordTypeInfosByName().get('Driving Licence').getRecordTypeId();
    Id rectypeid2 = Schema.SObjectType.Certification__c.getRecordTypeInfosByName().get('DVLA Licence Check').getRecordTypeId();
        ...
        if(trigger.isupdate && trigger.new[i].Verfied__c != trigger.old[i].Verfied__c && trigger.new[i].Verfied__c==True && (trigger.new[i].recordTypeID==rectypeid || trigger.new[i].recordTypeID == rectypeid2))
        {
            ...
            for(Certification__c cert : trigger.new)
            {
                if(cert.Verfied__c==True && cert.Standard__c==True){
                    ...
                    verify.put('Drivers Licence(Standard)',cert.Contact__c);  
                ...
                {
                    conID.add(cert.Contact__c);
                    verify.put('PCV Licence',cert.Contact__c);  
                ...
                {
                    conID.add(cert.Contact__c);
                    verify.put('LGV ADR C1 Licence',cert.Contact__c);  
                ...
                {
                    conID.add(cert.Contact__c);
                    verify.put('LGV ADR C Licence',cert.Contact__c);  
                ...
                {
                    conID.add(cert.Contact__c);
                    verify.put('LGV HIAB C Licence',cert.Contact__c);  
                ...
                {
                    conID.add(cert.Contact__c);
                    verify.put('LGV ADR C1+E Licence',cert.Contact__c);  
                ...
                if(cert.Verfied__c && cert.RecordTypeid==rectypeid2){
                    ...
                    conID.add(cert.Contact__c);
                    verify.put('DVLA Licence Check',cert.Contact__c);  
                ...
                if(cert.Verfied__c && cert.RecordTypeid==rectypeid){
                    ...
                    verify.put('Driving Licence (Standard)',cert.Contact__c); 
                ...
                if(cert.Verfied__c && cert.Class_B_Car_Van__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('Car/Van Driver Skill',cert.Contact__c);
                ...
                {
                    conID.add(cert.Contact__c);
                    verify.put('LGV C1 Licence',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.Class_C_Large_Lorries__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c); 
                    verify.put('LGV C Licence',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.Class_C1_E_Small_Lorry_Trailer__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c); 
                    verify.put('LGV C1+E Licence',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.Class_C_E_Articulated_Lorry__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('LGV C + E Licence',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.Class_C_E_102_Draw_Bar_Only__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c); 
                    verify.put('LGV C + E Licence (102 Restriction)',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.Class_D_Bus_Coach__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('LGV D Licence',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.Class_D_Minibus__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('LGV D1 Licence',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.Digicard__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('Digicard',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.ADR__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('ADR',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.CPC__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('DQC (CPC) Card',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.PCV__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('PCV',cert.Contact__c);
                ...
                if(cert.Verfied__c && cert.HIAB__c && cert.RecordTypeid==rectypeid){
                    conID.add(cert.Contact__c);
                    verify.put('HIAB',cert.Contact__c);
