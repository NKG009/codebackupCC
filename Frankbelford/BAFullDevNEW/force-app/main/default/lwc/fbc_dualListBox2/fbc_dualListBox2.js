...
export default class dualListBoxFSC extends LightningElement {
    ...
    handleValueChanged(event) {
        console.log('=================== handleValueChanged : dualListBox');
    ...
    dispatchFlowAttributeChangedEvent(attributeName, attributeValue) {
        console.log('=================== attributeName : '+JSON.stringify(attributeName));
        console.log('=================== attributeValue : '+JSON.stringify(attributeValue));
        const attributeChangeEvent = new FlowAttributeChangeEvent(
            attributeName,
            attributeValue
        );
        console.log('=================== dispatchEvent : '+JSON.stringify(attributeChangeEvent));
