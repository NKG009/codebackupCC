...
export default class RequestShiftVacancyModal extends LightningElement {
  ...
  availableReason = [
    { label: ' New job role', value: ' New job role' },
    { label: 'Additional workload', value: 'Additional workload' },
    { label: 'Holiday cover', value: 'Holiday cover' },
    { label: 'Sickness cover', value: 'Sickness cover' },
    { label: 'Compassionate Leave cover', value: 'Compassionate Leave cover' },
    { label: 'Maternity Leave cover', value: 'Maternity Leave cover' },
    { label: 'Paternity Leave cover', value: 'Paternity Leave cover' },
    { label: 'Parental Leave cover', value: 'Parental Leave cover' }
  ];
  ...
  handleReasonforrequirementChange(event) {
