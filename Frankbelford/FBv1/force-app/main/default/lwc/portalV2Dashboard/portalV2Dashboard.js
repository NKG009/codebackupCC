...
*/
  ...
  @wire(getRecord, {
    recordId: "$contactId",
    fields: [ACCOUNT_ID_FIELD,VMS_CONTACT_FIELD,VMS_CLIENT_CONTACT_FIELD]
  })
  contact(data, error) {
    if (data) {
  ...
  connectedCallback() {
    console.log('timesheetPageName' +this.timesheetPageName + '44myShiftsPageName'+this.myShiftsPageName);
