...
import applyAmendedShiftHoursToAllShifts from "@salesforce/apex/PortalV2TimesheetsController.applyAmendedShiftHoursToAllShifts";
...
export default class PortalV2Timesheets extends NavigationMixin(
  LightningElement
) {
  //#region Variables
  timeZone = TIME_ZONE;
    ...
    return [
      {
        ...
        filterTerms: {
          ...
          startDate: `${twoWeeksAgo.getFullYear()}-${
