  ...
  columnsDataMap = new Map();
    ...
    contact(data, error) {
      if (data) {
        ...
        console.log(
          "contactRecord: " + JSON.stringify(this.contactRecord));
    ...
    closeModal() {
        ...
        const vmsclientportaltype = this.contactRecord.data.fields.Portal_Type__c.value;
            if(vmsclientportaltype ==="VMS - Authorised Booker"){
              this.shownewcreatebutton=true;
            }
        console.log('shownewcreatebutton: '+this.shownewcreatebutton);
        console.log(
          "contactRecord: " + JSON.stringify(this.contactRecord));
    ...
    getCommunityBaseURL() {
      getCurrentCommunityUrl()
          .then(result => {
              ...
              console.log(
                  'communityBaseUrl: ' + this.communityBaseUrl);
          })
          .catch(error => {
    ...
    async connectedCallback() {
      ...
      flattenShifts() {
        try {
          console.log('here in flattenShifts' );
          console.log(
            'communityBaseUrl in fs: ' + this.communityBaseUrl);
