...
export default class PortalV2ApproveAndEndorseVmsClient extends LightningElement {
  ...
  loading = true;
   ...
   @api hasZeroBreak; 
   connectedCallback() {
        console.log('==============Has Zero Break child :', this.hasZeroBreak);
    }
  ...
  /*---new changes */
  showConfirmation = false; // Add this property

confirmApproval() {
  if (this.hasZeroBreak) {
