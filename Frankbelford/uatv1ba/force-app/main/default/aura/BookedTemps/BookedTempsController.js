({
    ...
    cancelShift: function(component, event, helper) {
        var target = event.getSource();
        var idToBeCancelled = target.get("v.value");
        console.log("idToBeCancelled--"+idToBeCancelled);
        
        var phonedetail=component.get('c.getPhoneDetails');
        var self = this;
        phonedetail.setParams({
            "shiftId" : idToBeCancelled
        });
        phonedetail.setCallback(this, function(actionResult) {
            console.log("-----"+actionResult.getReturnValue());
            component.set("v.phonedetails", actionResult.getReturnValue());
            
        });
        $A.enqueueAction(phonedetail);
