  ...
  processMenuItems(data) {
    ...
    this.menuItems = data
      .map((item, index) => {
        ...
        // else if((item.Target === '/todays-workforce') && !vmsContact){
        //   if(vmsclientportaltype ==="VMS - Hours Approver" && item.Target === '/todays-workforce'){
        //     showMenuItem = false;
        //   }
        //   else{
        //     showMenuItem = true;
        ...
        // }
        else if (vmsContact) {                  // vms supplier part
          const allowedItems = [
            "/my-timesheets",
            "/my-candidates",
            "/my-job-order",
        ...
        else if (vmsClientContact) {          // vms client part
          const allowedItems = [
            "/shift-approval-vms",
          ...
          showMenuItem = allowedItems.includes(item.Target);
          if((item.Target === "/job-order-vms-client" )&& vmsclientportaltype ==="VMS - Hours Approver"){     // removed || item.Target === "/my-shifts-vms-client" 
            showMenuItem = false;
          }
          if((item.Target === "/timesheets-vms-client" || item.Target === "/shift-approval-vms" )&& vmsclientportaltype ==="VMS - Authorised Booker"){
            showMenuItem = false;
          }
        }
