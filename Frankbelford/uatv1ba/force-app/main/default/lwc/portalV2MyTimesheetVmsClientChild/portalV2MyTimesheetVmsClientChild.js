...
import getShifts from "@salesforce/apex/TimesheetPageApexController.getShiftsByUserAccountVmsClient";
import getPastShifts from "@salesforce/apex/TimesheetPageApexController.getPastShiftsByUserAccountVmsClient";
import getRatings from "@salesforce/apex/ShiftPageApexController.getRatings";
import fetchAdjustableColumns from "@salesforce/apex/TimesheetPageApexController.fetchAdjustableColumnsVMS";
...
export default class PortalV2MyTimesheetVmsClientChild extends LightningElement {
  pageRef;
  ...
  get mainSelectedRows() {
    console.log('==================================== this.filteredShifts 1 : '+JSON.stringify(this.filteredShifts));
  ...
  get subSelectedRows() {
    ...
    console.log('==================================== this.filteredShifts 2 : '+JSON.stringify(this.filteredShifts));
    ...
    console.log('==================================== selectedMainRows 3 : '+JSON.stringify(selectedMainRows));
  ...
  get shiftArray() {
    console.log('================================= this.currentShiftView : '+this.currentShiftView);
  ...
  async connectedCallback() {
    ...
    try {
      ...
      console.log('========================== adjustableColumnConfig : ' + JSON.stringify(adjustableColumnConfig));
  ...
  adjustColumnsConfigurations(adjustableColumnConfig) {
    ...
    console.log('mainTableColumnStatus:'+ JSON.stringify(this.mainTableColumnStatus));
    console.log('subTableColumnStatus:'+ JSON.stringify(this.subTableColumnStatus));
    //console.log('==================================== this.filteredShifts 1 : '+JSON.stringify(this.filteredShifts));
  }
  ...
  async getShifts() {
   // console.log('==================================== this.filteredShifts 1 : '+JSON.stringify(this.filteredShifts));
    ...
    //  console.log('==================================== this.filteredShifts 1 : '+JSON.stringify(this.filteredShifts));
    //  console.log('==============================================================getShifts=== 1 : ' + results);
      this.numRecordsChanged();
    //  console.log('==================================== this.shiftArray : '+JSON.stringify(this.shiftArray));
      this.initPagination(this.shiftArray);
    //  console.log('==================================== this.filteredShifts 1 : '+JSON.stringify(this.filteredShifts));
      this.loading = false;
  ...
  async getCurrentShifts() {
    ...
    console.log('==============================================================currentShifts===' + JSON.stringify(currentShifts));
  ...
  async getPastShifts() {
    ...
    this.pastShifts = this.flattenShifts(pastShifts, retrievedPastRatings);
     console.log('===========================================this.pastShifts = this.flattenShifts===' + JSON.stringify(this.flattenShifts));
  }

  flattenShifts(retrievedShifts, retrievedRatings) {
    console.log('================================= retrievedShifts : '+JSON.stringify(retrievedShifts));
    let sortedShifts = [];
    
    retrievedShifts.forEach((shift) => {
      //Generate ratings
      console.log('shiftrec timesheetno:'+shift.Name +'========workrname:'+shift.sirenum__Worker__r.Name);
      const ratings =
      ...
      console.log('================================= sortedShifts : '+JSON.stringify(sortedShifts));
      const filteredShift = sortedShifts.find((sortedShift) => {
        //Get relevant column
        console.log('this.groupingColumnName===:'+this.groupingColumnName);
        const column = sortedShift.columnInfo.find(
          (item) => item.column === 'Name'
        );
        if(column != undefined){
        console.log('column daat:'+JSON.stringify(column));
        const shiftValue = getLookupReferenceData(shift, column.key);
        console.log('shiftValue :'+JSON.stringify(shiftValue));
        return column.value === shiftValue;
        }
      });
      console.log('================================= filteredShift IS NULL : '+JSON.stringify(filteredShift));
      // if there is a match
      if (filteredShift !== undefined) {
        console.log('========================generateChildShift ');
        ...
        console.log('========================generateTopLevelShift');
  ...
  generateTopLevelShift(shift, ratings) {
    ...
    console.log('===========================from parent generateChildShift');
  ...
  generateChildShift(shift, parent, ratings) {
   // console.log('===========================generateChildShift called');
  ...
  toggleSubTableShow(event) {
    ...
    console.log('===================================== this.filteredShifts : '+JSON.stringify(this.filteredShifts));
  }
  ...
  @api
  exportData() {
     console.log('=============================exportData running');
    try {
      let csvRows = [];
      ...
      console.log('=============================exportData running',headerRow);
      this.subTableColumnStatus.forEach((column) => {
        if (column.selected === true) {
          headerRow.push(column.column);
        }
      ...
      csvRows.push([...new Set(headerRow)]);
        ...
        console.log('=============================exportData running',csvRows);
