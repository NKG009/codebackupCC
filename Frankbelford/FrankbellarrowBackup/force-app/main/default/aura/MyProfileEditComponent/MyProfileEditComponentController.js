({
    ...
    submitLoggedInuserInfo : function(component, event, helper) {
        helper.submitLoggedInuserInfo(component);		
    },
   dashboardnavigate: function(component, event, helper)
    ...
    {
        event.preventDefault();
        var urlRedirect = $A.get("$Label.c.Lightning_Component_URL")+"fastbooking"+'?site='+component.find("siteId").get("v.value");
        window.location.replace(urlRedirect);
        return false;
    },
   fastBookingNavigate: function(component, event, helper)
    ...
    myprofilesaveview : function(component,event, helper) {
