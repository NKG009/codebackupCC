({
    ...
    //    console.log("id For Feedback --"+idToBeCancelled);
        ...
        for (var i = 0; i < shiftList.length; i++) {
          ...
          //     console.log('rating value'+shiftList[i].ClientBlueArrowRakingStored__c);
    ...
    submitRating: function(component, event, helper) {
     ...
     //   console.log("selectedRating"+selectedRating);
        ...
        if(siteIdvalue == undefined || siteIdvalue == ""){            
           ...
           // console.log('action'+siteIdvalue);
           // console.log('action'+component.get("v.feedbackshift").Id);
             //  console.log('action'+component.get("v.selectedRating"));
             //  console.log('action'+component.find("jobRole").get("v.value"));
            
             //console.log('action'+document.getElementById("timePeriod").value);
