import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfESMProductRelationshipModal_8_VlocityExpress extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0koDp000000Pct7IAC"
                );
                this.loadCustomStylesheetAttachement("00PDp00000BoRpWMAV");
