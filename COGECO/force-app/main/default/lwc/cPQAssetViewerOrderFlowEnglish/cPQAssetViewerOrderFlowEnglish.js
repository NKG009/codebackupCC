...
import { OMNIDEF } from './cPQAssetViewerOrderFlowEnglish_def.js';
import tmpl from './cPQAssetViewerOrderFlowEnglish.html';
import tmpl_nds from './cPQAssetViewerOrderFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQAssetViewerOrderFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
