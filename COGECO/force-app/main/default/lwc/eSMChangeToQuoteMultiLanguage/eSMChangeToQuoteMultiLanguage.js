...
import { OMNIDEF } from './eSMChangeToQuoteMultiLanguage_def.js';
import tmpl from './eSMChangeToQuoteMultiLanguage.html';
import tmpl_nds from './eSMChangeToQuoteMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMChangeToQuoteMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
