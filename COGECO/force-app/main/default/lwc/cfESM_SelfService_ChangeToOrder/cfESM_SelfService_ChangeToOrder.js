import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfESM_SelfService_ChangeToOrder extends FlexCardMixin(LightningElement){
        ...
        @api set cfPreviousPageApi(val) {
          ...
          return this._sessionApiVars["PreviousPageApi"] || "Assets__c";
              ...
              @track Label={CMEXSelfServiceNextButton:"Next",
        CPQNew:"New",
        CMEXSelfServicePreviousButton:"Previous",
        CMEXSelfServiceChangeToOrderTypeOneTime:"One Time",
        CMEXSelfServiceChangeToOrderTypeBulk:"Bulk",
        CMEXSelfServiceChangeToOrderStartDate:"Order Start Date",
        CMEXSelfServiceChangeToOrderName:"Order Name",
        CMEXSelfServiceChangeToOrderInfo2:"Create a new order over the existing assets which have been selected",
        CMEXSelfServiceChangeToOrderInfo:"Create change order from the existing assets",
        CMEXSelfServiceChangeToOrderHeading:"Create a change Order"
        };
              pubsubEvent = [];
              customEvent = [];
