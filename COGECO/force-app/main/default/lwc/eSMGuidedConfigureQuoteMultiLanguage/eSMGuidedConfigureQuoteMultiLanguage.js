...
import { OMNIDEF } from './eSMGuidedConfigureQuoteMultiLanguage_def.js';
import tmpl from './eSMGuidedConfigureQuoteMultiLanguage.html';
import tmpl_nds from './eSMGuidedConfigureQuoteMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMGuidedConfigureQuoteMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
